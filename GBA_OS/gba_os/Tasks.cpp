...
IWRAM_CODE ARM_CODE void update_screen_mode_4_task(Task& task){
    ...
    switch (mode45_active_screen_buffer) {
        case 0:
            DMA3COPY(screen_buffer, (void*)(VRAM), DMA_DST_INC | DMA_SRC_INC | DMA32 | DMA_VBLANK | (240 * 160 / 4));
            REG_DISPCNT &= ~((u16)BACKBUFFER); // Use front buffer
            break;
        case 1:
            DMA3COPY(screen_buffer, (void*)(VRAM + 0xA000), DMA_DST_INC | DMA_SRC_INC | DMA32 | DMA_VBLANK | (240 * 160 / 4));
